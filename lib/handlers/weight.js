...
var controlValues = require('../control-values');

/*
KERNEL begin
*/
var kernelLogger = require('../kernel/logger');
/*
KERNEL end
*/
...
exports.writeToDatabase = function(port, data) {
  ...
  plugin.execute(port, dataFromStream, function(ready, processedData) {
    if (ready) {
      ...
      Weight.new(weight, function(err, rec) {
        ...
        controlValues.update(path, weight.value);
        ...
        KERNEL begin
        */
        kernelLogger.write(port.path, weight.date, weight.value);
        /*
        KERNEL end
        */
      });
