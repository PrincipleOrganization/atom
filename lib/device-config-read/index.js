...
module.exports.deviceConfigurations = function(port) {
  ...
  if (device) {
    ...
    deviceConfigurations.commonRequestBytes     = vendor[device.vendor][device.model].commonRequestBytes;
    deviceConfigurations.options                = new OptionsCreator(device.options);
    deviceConfigurations.setzero                = vendor[device.vendor][device.model].setzero;
  }
