...
module_self.writeToPort = function(comName, cmd, callback) {
  ...
  if (port) {
    ...
    var table = global._config.device.serialport.table;
    var vendor = global._config.device.serialport.vendor;
    var model = global._config.device.serialport.model;

    var devModelsConf = require(`../../vendor/${table}.json`);
    var brkLineCode = devModelsConf[vendor][model].brkLineCode;
